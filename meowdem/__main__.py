...
def main():
    ...
    print("Dialing...")
    response = interpreter.receive_data("ATD12345\r")
    print(response)
    
    print("\nSending data in data mode:")
    response = interpreter.receive_data("Hello, this is test data!")
    print(response)
    
    print("\nSending escape sequence with guard time:")
    # Send escape sequence
    print("Sending: +++")
    interpreter.receive_data("+++")
    ...
    response = interpreter.receive_data("")  # Empty string to check status
    ...
    response = interpreter.receive_data("ATO\r")
    print(response)
    
    # Send data again in data mode
    print("\nSending more data:")
    response = interpreter.receive_data("Back in data mode!")
    print(response)
    ...
    response = interpreter.receive_data(multi_commands)
    print("Response:", response)
